...
This document describes only the `core` semantic factgraph. It does not cover implementation details of:
...
src/factgraph/core/
  ...
  annotation/              # internal prototype annotation factgraph (A/C workload slice)
...
- `factgraph_WHERE_AST_VALIDATE=0|false|False|off|OFF` disables the gate
- default is enabled
