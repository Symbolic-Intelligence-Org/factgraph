...
The PyReason adapter is factgraph's integration with the
...
```python
from factgraph.adapters.pyreason.accept import accept_pyreason_session
...
This is not full factgraph entity-identity alignment; it merely
