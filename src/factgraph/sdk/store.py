...
from factgraph.core.view.projector import project_display_facts
...
class SDKStore:
    ...
    def __init__(
        ...
        *,
        ...
        self._env_row_format = os.environ.get("factgraph_ROW_FORMAT")
        self._index_schema()
...
def _resolve_row_format(*, call_site: Any, store_default: Any, env_var: Any) -> str:
    for raw_value, path, source in (
        ...
        (env_var, "env:factgraph_ROW_FORMAT", "env_var"),
    ):
...
def _warn_deprecated_tuple_row_format_if_needed(normalized: str, *, source: str) -> None:
    ...
    warnings.warn(
        ...
        f"(source={source}); use row_format='dict' or set factgraph_ROW_FORMAT=dict.",
        DeprecationWarning,
        stacklevel=4,
    )
