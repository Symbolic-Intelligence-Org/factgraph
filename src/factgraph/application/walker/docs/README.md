...
PYTHONPATH=src python -m unittest \
  src.factgraph.tests.test_walker_keys \
  src.factgraph.tests.test_walker_views_support \
  src.factgraph.tests.test_walker_views_proof_frame \
  src.factgraph.tests.test_walker_views_proof_frame_diff \
  src.factgraph.tests.test_walker_invariants \
  src.factgraph.tests.test_walker_views_frozen_tuple \
  src.factgraph.tests.test_walker_ir \
  src.factgraph.tests.test_walker_errors -v
```
