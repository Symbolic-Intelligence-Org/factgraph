...
_VALID_NODE_KINDS = frozenset((NODE_CONCLUSION, NODE_PREMISE, NODE_SEED, NODE_RULE_EXPR, NODE_RULE, NODE_ATOM))
_VALID_EDGE_KINDS = frozenset(
    (EDGE_SUPPORTS, EDGE_DERIVES, EDGE_UPDATES, EDGE_DERIVED_BY, EDGE_USES, EDGE_HAS_ATOM, EDGE_SUPPORTED_BY)
)
