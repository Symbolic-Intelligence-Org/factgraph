...
_ECSS_COMPLIANCE_OPTIONAL_DOMAIN_MESSAGE = (
    ...
    "The factgraph v0.1 wheel is factgraph-only and does not include domains; "
...
def _load_ecss_compliance_helpers() -> tuple[type[Exception], Any]:
    try:
        from factgraph.domains.ecss.compliance import AuditComplianceError, build_compliance_matrix_rows
