...
class AgentLayer4ARuntimeAPITests(unittest.TestCase):
    def test_local_runtime_api_validate_rule_dispatches_to_rules_v1(self) -> None:
        ...
        with patch("service.rules_v1.validate_rule", return_value=expected) as mocked:
    ...
    def test_local_runtime_api_compile_rule_preview_dispatches_to_rules_v1(self) -> None:
        ...
        with patch("service.rules_v1.compile_rule_preview", return_value=expected) as mocked:
    ...
    def test_local_runtime_api_ephemeral_rule_methods_dispatch_to_runtime(self) -> None:
        ...
        with patch(
            "service.runtime_v1.register_ephemeral_rule",
        ...
        with patch(
            "service.runtime_v1.list_ephemeral_rules",
            return_value={"ok": True},
        ) as list_mock:
        ...
        with patch(
            "service.runtime_v1.clear_ephemeral_rules",
            return_value={"ok": True},
        ) as clear_mock:
