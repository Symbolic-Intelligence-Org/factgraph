...
from agent.extraction.llm import build_response_model
...
class NormalizeFieldValuesAcceptsObjectFormTest(unittest.TestCase):
    ...
    def test_accepts_dict_form(self) -> None:
        from agent.extraction.validation import _normalize_field_values
    ...
    def test_rejects_non_string_tag(self) -> None:
        from agent.extraction.validation import _normalize_field_values
        from agent.errors import AgentContractError
...
class NormalizeEntityIdentityTest(unittest.TestCase):
    ...
    def test_accepts_dict_form(self) -> None:
        from agent.extraction.validation import _normalize_entity_identity
