...
本目录记录 `src/agent/extraction` 的当前实现口径，覆盖 Layer 4C3-a 的 single-segment LLM extraction、Layer 4C3-b 的 batch extraction orchestration、Layer 4C3-c 的单文档 entity resolution，以及三层 extraction hook 的最小 observability 集成点。
