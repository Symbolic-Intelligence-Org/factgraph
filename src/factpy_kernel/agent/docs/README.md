...
本目录记录 `src/factpy_kernel/agent` 的当前实现口径，覆盖对话式 agent 的控制面、read-first review loop、结构化最小写入、精确撤回、native-first 规则 authoring、保守版引擎路由、确定性 document staging、文档 fact draft 的 bundle review/approval、single-segment / batch LLM extraction、单文档 entity resolution，以及 extraction 三层的 Langfuse 最小 observability。
...
- `src/factpy_kernel/tests/test_agent_l4a_runtime_api.py`
- `src/factpy_kernel/tests/test_agent_l4a_rules.py`
- `src/factpy_kernel/tests/test_agent_l4a_workflow.py`
- `src/factpy_kernel/tests/test_agent_l4b_routing.py`
- `src/factpy_kernel/tests/test_agent_l4b_workflow.py`
- `src/factpy_kernel/tests/test_agent_l4c1_models.py`
- `src/factpy_kernel/tests/test_agent_l4c1_clarity.py`
- `src/factpy_kernel/tests/test_agent_l4c1_txt_parser.py`
- `src/factpy_kernel/tests/test_agent_l4c1_pdf_parser.py`
- `src/factpy_kernel/tests/test_agent_l4c1_docx_parser.py`
- `src/factpy_kernel/tests/test_agent_l4c1_staging.py`
- `src/factpy_kernel/tests/test_agent_l4c2_models.py`
- `src/factpy_kernel/tests/test_agent_l4c2_bundle_manager.py`
- `src/factpy_kernel/tests/test_agent_l4c2_workflow.py`
- `src/factpy_kernel/tests/test_agent_l4c3a_models.py`
- `src/factpy_kernel/tests/test_agent_l4c3a_validation.py`
- `src/factpy_kernel/tests/test_agent_l4c3a_prompts.py`
- `src/factpy_kernel/tests/test_agent_l4c3a_extractor.py`
- `src/factpy_kernel/tests/test_agent_l4c3a_workflow.py`
...
- `src/factpy_kernel/tests/test_agent_observability_noop.py`
- `src/factpy_kernel/tests/test_agent_observability_build_tracer.py`
- `src/factpy_kernel/tests/test_agent_observability_langfuse.py`
...
- `src/factpy_kernel/agent/observability/docs/README.md`
