...
from factpy_kernel.core.store._support import SupportArtifact, support_artifact_to_dict


def render_support_artifact(artifact: SupportArtifact) -> dict[str, Any]:
