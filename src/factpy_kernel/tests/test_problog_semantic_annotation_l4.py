...
from factpy_kernel.audit.reader import load_audit_package
from factpy_kernel.audit.static_ui import _render_annotation_panel
...
class ProbLogSemanticAnnotationParityTests(unittest.TestCase):
    ...
    def test_evaluate_caches_pending_probability_annotation(self, mock_run) -> None:
        ...
        candidate = sdk.evaluate(self._make_derivation())[0]
