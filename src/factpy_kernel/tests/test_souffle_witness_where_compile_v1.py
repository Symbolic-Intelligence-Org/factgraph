...
from factpy_kernel.core.rules.ruleref_common import internal_rule_pred_id
...
from factpy_kernel.sdk import Pred, Rule, RuleRef, SDKStore, vars as sdk_vars
from factpy_kernel.tests._test_helpers import User, _schema_ir as _runtime_schema_ir
...
class SouffleWitnessWhereCompileV1Tests(unittest.TestCase):
    ...
    def test_export_package_threads_query_registry_root_for_ruleref(self) -> None:
        ...
        with TemporaryDirectory() as package_dir:
            with patch(
                "factpy_kernel.adapters.souffle.package._load_query_rule_registry",
