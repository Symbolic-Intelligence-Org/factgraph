...
Each module's `docs/README.md` must cover these six items. See [docs/module_docs_convention.md](/Users/zhenzhili/symbolic_agent/docs/module_docs_convention.md) for the full spec and a copy-paste starter template.
