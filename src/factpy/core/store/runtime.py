...
from factpy.core.derivation.candidates import CandidateSet, make_candidate
from factpy.core.evidence.write_protocol import now_epoch_nanos
from factpy.core.mapping.canon import MappingResolution
from factpy.core.protocol.digests import sha256_token
from factpy.core.protocol.tup_v1 import canonical_bytes_tup_v1
from factpy.core.rules._trace import RuleTraceArtifact
from factpy.core.rules.where_eval import WhereValidationError
from factpy.core.store._explain_rule_trace import render_rule_trace_artifact
from factpy.core.schema.schema_ir import ensure_schema_ir
from factpy.core.store import _accept as _store_accept
from factpy.core.store._artifact_sidecar import ArtifactSidecar
from factpy.core.store._explain_support import render_support_artifact
...
from factpy.core.store.evaluation import evaluate_store
from factpy.core.store.ledger import Ledger
from factpy.core.store.queries import conflicts as store_conflicts
from factpy.core.store.queries import explain_fact as store_explain_fact
from factpy.core.store.queries import resolve_mapping as store_resolve_mapping
from factpy.core.store.types import (
    EngineExtBase,
    EngineEvaluatorFn,
    EngineOptionsIR,
    EvaluateMode,
