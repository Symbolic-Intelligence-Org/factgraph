...
`factpy.core.semantics` contains value objects and helpers for runtime
projection semantics. Track 3 / B introduced `SemanticsProfile` as a
validated core value object:

- SDK namespace export exists through `factpy.sdk.SemanticsProfile`
...
- ProbLog and PyReason may import `factpy.core.semantics.SemanticsProfile`
...
- Native evaluation is implemented in core, not as a
  `src/factpy/adapters/native/` package; public SDK/service calls reject
