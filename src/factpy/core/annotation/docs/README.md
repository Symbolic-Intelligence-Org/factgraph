...
- Scope: `src/factpy/core/annotation`
- Status: experimental / internal API
- Already consumed internally by factpy/core/store; breaking changes
...
"Souffle annotation factpy prototype".
