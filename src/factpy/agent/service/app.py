...
from factpy.agent.service.extraction_v1 import extract_document_endpoint as _extract_handler
from factpy.service._common import error_response
from factpy.service.auth import require_api_key
