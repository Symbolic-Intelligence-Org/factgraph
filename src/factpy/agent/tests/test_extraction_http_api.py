...
from factpy.agent.extraction import ExtractionDocumentError, ExtractionDocumentResult
from factpy.agent.extraction.metrics import BatchExtractionMetrics
from factpy.agent.service.app import app
...
class ExtractionHttpApiTests(unittest.TestCase):
    def test_extract_document_endpoint_success(self) -> None:
        with patch.dict(os.environ, {"FACTPY_KERNEL_AUTH_DISABLED": "true"}, clear=False):
            with patch(
                "agent.service.extraction_v1.extract_document_from_ir",
