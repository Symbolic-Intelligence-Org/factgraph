...
`src/factpy/application`. `application` is the canonical Python
...
> batches, or user-facing exceptions, read `src/factpy/sdk/docs/`
> first and start from `factpy.sdk`.
>
...
- `src/factpy/application/docs/01_overview_en.md`
  - English overview of the application module.
- `src/factpy/application/walker/docs/README.md`
  - Current implementation contract for the application-layer walker
    module.
- `src/factpy/application/schema_mutation_runtime.py`
