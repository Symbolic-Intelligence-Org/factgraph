...
from factpy.audit.authoring_events import load_authoring_apply_events, summarize_authoring_apply_events
from factpy.audit.assertions import load_assertion_index
from factpy.audit.dto import (
...
from factpy.audit.evidence_graph import EvidenceGraph, render_evidence_graph_html
from factpy.audit.query import AuditQuery
...
def render_audit_static_site(package_dir: str | Path, out_dir: str | Path) -> dict[str, Any]:
    ...
    for candidate_id in sorted(
        ...
        evidence_graph = query.get_candidate_evidence_graph(candidate_id)
