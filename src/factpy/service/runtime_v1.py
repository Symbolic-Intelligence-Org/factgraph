...
from factpy.adapters.problog.rule_ext import resolve_problog_engine_ext
...
from factpy.authoring.rules import compile_authoring_rule_v1
from factpy.core.derivation.accept import AcceptOptions, AcceptResult
from factpy.core.derivation.candidates import CONFIDENCE_KINDS, CandidateSet
from factpy.core.evidence.write_protocol import add_field, retract_by_asrt, set_field
from factpy.core.mapping.canon import MappingConflictError, MappingResolution
...
from factpy.core.rules.rule_ir import RuleCompileError, RuleRegistry, RuleSpec, run_rule, run_rule_with_trace
from factpy.core.rules._trace import summarize_rule_trace_artifact_dict
from factpy.core.schema.schema_ir import schema_digest
from factpy.core.semantics import SemanticsProfile
from factpy.core.store import builders
from factpy.core.store._artifact_sidecar import FileArtifactSidecar
from factpy.core.store._candidate_evidence_tree import (
    build_candidate_evidence_tree,
    build_degraded_candidate_evidence_tree,
)
from factpy.core.store._candidate_evidence_tree_narrative import (
    render_candidate_evidence_tree_narrative,
)
from factpy.core.store._candidate_evidence_tree_nl import (
    render_candidate_evidence_tree_nl_explain,
)
from factpy.core.store._candidate_evidence_tree_summary import (
...
from factpy.core.store.ledger import Claim, ClaimArg, Ledger, MetaRow
from factpy.core.store.types import ReadPolicy
from factpy.core.view.projector import (
    project_display_facts,
    project_view_facts,
    project_view_facts_with_audit,
)
from factpy.audit import build_rule_trace_detail_payload
from factpy.audit.evidence_graph import evidence_graph_to_dict
from factpy.service.static_ui import render_candidate_evidence_html, render_rule_trace_detail_html
...
def _explain_timeline_candidate(session: Any, candidate_id: str) -> dict[str, Any]:
    ...
    from factpy.adapters.pyreason.provenance import pyreason_trace_from_dict
    from factpy.core.store._candidate_provenance_timeline import (
...
def _materialize_provenance_trees(
    ...
    from factpy.adapters.souffle.provenance import run_package_provenance
    from factpy.adapters.souffle.package import _load_query_rule_registry
    from factpy.adapters.souffle.runner import run_package
    from factpy.adapters.souffle.tsv_v1 import tsv_cell_v1_decode
