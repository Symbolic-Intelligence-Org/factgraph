...
from factpy.core.store._support import _DEGRADED_SUPPORT_KINDS, _WITNESS_BEARING_SUPPORT_KINDS
from factpy.core.store._support import _PROVENANCE_BEARING_SUPPORT_KINDS
...
def _load_ecss_compliance_helpers() -> tuple[type[Exception], Any]:
    try:
        from factpy.domains.ecss.compliance import AuditComplianceError, build_compliance_matrix_rows
