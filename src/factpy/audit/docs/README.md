...
`src/factpy/audit`, targeting developers who need to read audit
...
delivery layer, not to the factpy-only package.

## Current documents

- `src/factpy/audit/docs/01_overview.en.md`
  - audit module responsibilities, public entry points, audit
    workflow, round event log, and boundaries with runtime / registry.
- `src/factpy/audit/docs/02_evidence_graph.md`
