...
from kernel.application.capability_helpers import build_rule_disable_request
from kernel.application.capability_helpers.errors import CapabilityHelperError
from kernel.application.protocol import ProtocolShapeError, RuleDisableResult
...
def sdk_rule_disable(
    ...
    *,
    ...
    try:
        ...
        raise SDKStoreError(
            f"invalid check_rule_disable dependencies: {exc}",
