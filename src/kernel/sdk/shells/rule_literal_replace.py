...
Implements the ``SDKStore.check_rule_literal_replace`` facade method
per the active G3 blueprint
...
from kernel.application.capability_helpers import build_rule_literal_replace_request
from kernel.application.capability_helpers.errors import CapabilityHelperError
from kernel.application.protocol import ProtocolShapeError, RuleLiteralReplaceResult
...
def sdk_rule_literal_replace(
    ...
    *,
    ...
    try:
        ...
        raise SDKStoreError(
            f"invalid check_rule_literal_replace dependencies: {exc}",
