...
from kernel.adapters.souffle.souffle_view_gen import witness_rel_name
from kernel.core.rules.ruleref_common import internal_rule_pred_id, resolve_exposed_rule_ref
...
from kernel.core.store._support import make_pred_atom_key
