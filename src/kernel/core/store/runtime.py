...
from kernel.core.derivation.candidates import CandidateSet, make_candidate
from kernel.core.evidence.write_protocol import now_epoch_nanos
from kernel.core.mapping.canon import MappingResolution
from kernel.core.protocol.digests import sha256_token
from kernel.core.protocol.tup_v1 import canonical_bytes_tup_v1
from kernel.core.rules._trace import RuleTraceArtifact
from kernel.core.rules.where_eval import WhereValidationError
from kernel.core.store._explain_rule_trace import render_rule_trace_artifact
from kernel.core.schema.schema_ir import ensure_schema_ir
from kernel.core.store import _accept as _store_accept
from kernel.core.store._artifact_sidecar import ArtifactSidecar
from kernel.core.store._explain_support import render_support_artifact
...
from kernel.core.store.evaluation import evaluate_store
from kernel.core.store.ledger import Ledger
from kernel.core.store.queries import conflicts as store_conflicts
from kernel.core.store.queries import explain_fact as store_explain_fact
from kernel.core.store.queries import resolve_mapping as store_resolve_mapping
from kernel.core.store.types import (
    EngineExtBase,
    EngineEvaluatorFn,
    EngineOptionsIR,
    EvaluateMode,
