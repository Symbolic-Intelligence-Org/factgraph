...
from kernel.sdk import Entity, Field, Identity, SDKStore, SDKStoreError  # noqa: I001
from kernel.audit.proof_frame_diff import ProofFrameDiff, ProofFrameDiffError
...
class SDKDiffProofFramesContractTests(unittest.TestCase):
    ...
    def test_sibling_diff_proof_frames_module_does_not_import_sibling_sdk_shells(
        ...
        sisters)."""
        import kernel.sdk.shells.proof_frame_diff as proof_frame_diff_module
