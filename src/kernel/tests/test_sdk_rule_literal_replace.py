...
class SDKRuleLiteralReplaceContractTests(unittest.TestCase):
    ...
    def test_capability_helper_error_remaps_to_request_path(self) -> None:
        ...
        with patch(
            "kernel.sdk.shells.rule_literal_replace.build_rule_literal_replace_request",
    ...
    def test_unexpected_runtime_exception_remaps_to_base_path(self) -> None:
        ...
        with patch(
            "kernel.sdk.shells.rule_literal_replace.check_rule_literal_replace_action",
    ...
    def test_rule_literal_replace_result_not_exported_from_kernel_sdk_all(
        self,
    ) -> None:
    ...
    def test_sibling_module_does_not_import_sibling_sdk_shells(self) -> None:
        import kernel.sdk.shells.rule_literal_replace as rule_literal_replace_module
