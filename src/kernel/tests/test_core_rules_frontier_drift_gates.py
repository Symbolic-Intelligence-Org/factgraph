...
from kernel.core.rules.ruleref_substrate import NativeWhereEvaluation, evaluate_native_where
...
class EvaluatorFrontierSurfaceGateTests(unittest.TestCase):
    ...
    def test_8_frontier_scope_stays_native_only(self) -> None:
        ...
        adapter_imports = [
            module
            for module in imported_modules
            if module == "kernel.adapters" or module.startswith("kernel.adapters.")
        ]
