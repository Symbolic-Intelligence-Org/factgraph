...
from kernel.core.store._support import _DEGRADED_SUPPORT_KINDS, _WITNESS_BEARING_SUPPORT_KINDS
from kernel.core.store._support import _PROVENANCE_BEARING_SUPPORT_KINDS
