...
from kernel.core.rules.ruleref_common import internal_rule_pred_id
...
from kernel.sdk import Pred, Rule, RuleRef, SDKStore, vars as sdk_vars
from kernel.tests._test_helpers import User, _schema_ir as _runtime_schema_ir
