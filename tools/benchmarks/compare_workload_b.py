...
from workload_b_reference import compare_result_to_golden


def main() -> None:
    parser = argparse.ArgumentParser(description="Compare Workload B baseline results against golden output.")
    parser.add_argument("--input", required=True, help="Workload B input JSON used to produce the results")
