...
from workload_d_reference import compare_result_to_golden


def main() -> None:
    parser = argparse.ArgumentParser(description="Compare Workload D baseline results against golden output.")
    parser.add_argument("--input", required=True, help="Workload D input JSON used to produce the results")
