...
| 2026-05-22 | implemented | Step 4.8 implementation closure | Implementation landed in `3aa229c6`: DSL ergonomic additions, `build_application_rule`, bridge rejection policy, docs, and tests. Targeted tests + ruff passed; full unittest discover still has unrelated baseline failures recorded in blueprint §10. |
