...
| 2026-08-14 | implementing | Product-interface implementation started | Parallel V2 contracts, public SDK facades, sealed runner/replay, structured presentation data, source bridge, and runnable tutorial are being implemented under the scoped Q20 boundary. |
| 2026-08-14 | implemented | Independent final verification passed | Application+SDK regression: 749 passed / 182 subtests; Q20 adversarial/protocol/source cohort: 57 passed / 7 subtests; public SDK notebook executed 11/11 cells with `factpy`. |
| 2026-08-14 | archived | Blueprint/audit pair archived | Current behavior is carried by the Q20 decision and module docs; this pair remains implementation rationale. |
...
- The final implementation records the current ProbLog `float64` projection in
  its sealed materialization capture; source-level point decimals are not
  misstated as arbitrary-precision engine observations.
