...
- [ ] Slice 2 implementation:`fg.fields.set(non_identity_field, e_ref_string_never_seen_by_shadow_store, value)` 在 first-write 路径 raise(per §4.2.4 forward direction)OR shipped lazy fallback OK with documented legacy status(Slice 2 blueprint 选其一)
