> 状态：部分实现  
> 类型：架构蓝图  
> 说明：本文档保留为历史总体设计蓝图；其中许多高层原则仍有价值，但整体方案并不等同于当前代码实现。
...
* Authoring 概念（Identity / Field / fact_key / reify）到 canonical SchemaIR/Rule 契约的映射见 `/Users/zhenzhili/hnsm-backend/docs/Authoring 层契约.md`。
...
* Exporter/Runner 的唯一权威规范见 `/Users/zhenzhili/hnsm-backend/docs/导出与运行.md` 的 `导出与运行（Exporter/Runner）规范（MVP）`。
