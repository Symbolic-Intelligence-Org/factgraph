...
目的：为 `/Users/zhenzhili/symbolic_agent/docs/architecture/specs/authoring/Authoring 层契约.md` 提供 **语义映射回归样例**。本文件只锁定：
...
- `authoring_ui_dto_v1.diagnostics_contract.codes/phases` 与 canonical registry 一致（见 `/Users/zhenzhili/symbolic_agent/docs/architecture/specs/authoring/Authoring 层契约.md` 第 7 节）
...
这些反例暂不要求本轮实现 parser，只要求后续 diagnostics code 与 `/Users/zhenzhili/symbolic_agent/docs/architecture/specs/authoring/Authoring 层契约.md` 第 7 节口径一致。
