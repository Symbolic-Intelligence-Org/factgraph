...
|---|---|---|---|---|
| `check-operation-conceptual-interaction.md` | **resolved** (conceptual + interaction,2026-05-03) | §P0-1 + §P0-2 + §P0-3 | `40_*` A 段 + `00_*` 命题 4 + `10_*/operational-...md` §"Check" | baseline P0-3 揭示 Check 是 P0 三个 capability 中最 ready-to-go(core primitives 已存在),需先收敛概念 + 交互;scoped implementation 前仍需 blueprint Step 0 冻结 protocol contract |
