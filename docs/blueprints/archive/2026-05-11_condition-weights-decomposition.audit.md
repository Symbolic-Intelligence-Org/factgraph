...
| 2026-05-12 | implemented | Closed and archived | Filled Outcome / Deviations, marked A4 implemented, and archived the blueprint pair. A4 closes the Track 3 A-slice public-surface decomposition by preserving `condition_weights` as certainty/explain projection input and making `SemanticsProfile.certainty_projection` the future migration target. |
