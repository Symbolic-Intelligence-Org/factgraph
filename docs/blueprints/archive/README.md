...
| 2026-05-05 | rule-disable | implemented | Batch 5a Rule Disable: Shape A `EvaluationOverlay.rule_actions`,single-action native `check_rule_disable_action(...)`,variant rows plus original-frame ProofFrame,Fact Overlay/ProofFrame rule-action rejection guards,no variant support capture,no SDK/service/agent drift; 159 focused + 1193 full kernel tests OK / 1 skipped |
