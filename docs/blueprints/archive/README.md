...
最后更新：2026-05-08 (G3 Rule Overlay SDK shells archived — three rule-overlay methods `check_rule_disable` / `check_rule_literal_replace` / `check_rule_add_condition`; three `#P1` retrofits on pre-G3 application-runtime boundary tests)
