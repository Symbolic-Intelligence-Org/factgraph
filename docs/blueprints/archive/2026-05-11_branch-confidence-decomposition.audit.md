...
| 2026-05-11 | implemented | Closed and archived | Filled Outcome / Deviations, marked blueprint implemented, archived the blueprint pair, and updated archive inventory. G0-G3 lineage is `f5702218 -> 67555bd1 -> db742172 -> 595a84d6 -> 137ed59f`; G4 closes the scoped unit. |
